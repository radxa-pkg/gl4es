...
.PHONY: clean-deb
clean-deb:
	rm -rf obj-aarch64-linux-gnu debian/.debhelper debian/libgl4es*/ debian/tmp/ debian/debhelper-build-stamp debian/files debian/*.debhelper.log debian/*.*.debhelper debian/*.substvars
